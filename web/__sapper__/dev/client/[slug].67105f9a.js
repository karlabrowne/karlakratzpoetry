...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1ilkolo");
			...
			attr_dev(div2, "class", "svelte-1ilkolo");
